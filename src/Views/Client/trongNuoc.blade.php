...
<div class="page_header clearfix page_margin_top">
    <div class="page_header_left">
        <h1 class="page_title">Tin Trong Nước</h1>
    </div>
...
<div class="page_layout clearfix">
    ...
    <div class="row">
        <div class="column column_2_3">
            <div class="row">
                <ul class="blog big">
                    <?php foreach ($tinTrongNuoc as $trong) {?>
                        <li class="post">
                            <a href="{{ url("client/{$trong['id']}/{$trong['idDirectory']}/show") }}" title="Built on Brotherhood, Club Lives Up to Name">
                                <img src='{{show_upload($trong['image'])}}' alt='img' >
                            </a>
                            <div class="post_content">
                                <h2 class="with_number">
                                    <a href="{{ url("client/{$trong['id']}/{$trong['idDirectory']}/show") }}" title="Built on Brotherhood, Club Lives Up to Name">{{$trong['title']}}</a>
                                ...
                                <ul class="post_details">
                                    <li class="category"><a href="index7855.html?page=category&amp;cat=world" title="WORLD">Trong nước</a></li>
                                    <li class="date">
                                        {{$trong['created_at']}}
                                    </li>
                                </ul>
                                ...
                                overflow: hidden;">{{$trong['content']}}</p>
                                <a class="read_more" href="{{ url("client/{$trong['id']}/{$trong['idDirectory']}/show") }}" title="Read more"><span class="arrow"></span><span>XEM THÊM</span></a>
                            </div>
                        </li>
                        <?php } ?>
                </ul>
        ...
        <div class="column column_1_3 page_margin_top">
            ...
            <div class="vertical_carousel_container clearfix">
                <ul class="blog small vertical_carousel autoplay-1 scroll-1 navigation-1 easing-easeInOutQuint duration-750">
                    @for ($i = 0; $i < 4; $i++)
                    <li class="post">
                        <a href="{{ url("client/{$tinTrongNuoc[$i]['id']}/{$tinTrongNuoc[$i]['idDirectory']}/show") }}" title="Study Linking Illnes and Salt Leaves Researchers Doubtful">
                            <span class="icon small gallery"></span>
                            <img src='{{show_upload($tinTrongNuoc[$i]['image'])}}' alt='img' style="width: 100px">
                        </a>
                        <div class="post_content">
                            <h5>
                                <a href="{{ url("client/{$tinTrongNuoc[$i]['id']}/{$tinTrongNuoc[$i]['idDirectory']}/show") }}" title="Study Linking Illnes and Salt Leaves Researchers Doubtful">{{$tinTrongNuoc[$i]['title']}}</a>
                            </h5>
                            <ul class="post_details simple">
                                <li class="category"><a href="indexdced.html?page=category&amp;cat=health" title="HEALTH">Trong nước</a></li>
                                <li class="date">
                                    {{$tinTrongNuoc[$i]['created_at']}}
                                </li>
                            </ul>
                        </div>
                    </li>
